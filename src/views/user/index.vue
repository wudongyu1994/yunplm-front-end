<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="userRules" :model="temp" label-position="right" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="Password" prop="password">
          <el-input v-model="temp.password" type="password" clearable :disabled="dialogStatus==='update'" />
        </el-form-item>
        ...
        <el-form-item label="Corp" prop="corp">
          <el-input v-model="temp.corp" clearable />
        </el-form-item>
...
export default {
  ...
  data() {
    ...
    const validateEmail = (rule, value, callback) => {
      if (value.length === 0 || isEmail(value)) {
        ...
        callback(new Error('email wrong'))
      }
    }
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.temp.password = '123456789012345678'
