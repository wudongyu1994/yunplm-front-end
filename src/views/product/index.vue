<template>
  <div class="app-container">
    <div style="margin: 20px;">
      ...
      <el-button v-if="hasRightAdd" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-plus" @click="handleCreate" />
    </div>
        ...
        <el-card class="box-card" :body-style="{ padding: '0px' }">
          <div class="card-wdy">
            ...
            <div class="card-container-wdy">
              ...
              <div>
                <el-input-number v-model="addingNums[index]" :min="1" :max="100" />
      ...
      <div class="div-wdy">
        ...
        >
          <el-form-item label="address" prop="address">
            <el-input v-model="orderTemp.address" clearable />
          </el-form-item>
          <el-form-item label="phone" prop="phone">
            <el-input v-model="orderTemp.phone" clearable />
          </el-form-item>
          <el-form-item label="note" prop="note">
            <el-input v-model="orderTemp.note" clearable />
          </el-form-item>
        </el-form>
      </div>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="proNo" prop="proNo">
          <el-input v-model="temp.proNo" clearable />
        </el-form-item>
        <el-form-item label="serial" prop="serial">
          <el-input v-model="temp.serial" clearable />
        </el-form-item>
        <el-form-item label="price" prop="price">
          <el-input v-model.number="temp.price" clearable />
        </el-form-item>
  ...
  methods: {
    ...
    getPro() {
      ...
      getProductVO().then(response => {
        ...
        this.addingNums = [...Array(this.total)].map((x) => 1)
        console.log('nums= ' + this.addingNums)
        this.listLoading = false
      })
    },
    resetTemp() {
    ...
    addPro(item, index) {
      const number = this.addingNums[index]
